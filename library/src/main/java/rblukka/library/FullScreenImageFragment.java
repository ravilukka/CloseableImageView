...
public class FullScreenImageFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            Glide.with(getContext()).load(getArguments().getString(ARGUMENT_URL)).asBitmap().into(new SimpleTarget<Bitmap>() {
                @Override
    ...
    private void initialiseViews(@NonNull final View view, @NonNull final Bitmap bitmap) {
        ...
        leftBorderView.setOnDragListener(new CloseableOnDragListener(new CloseableOnDragListener.OnDropListener() {
            @Override
            void onDragStarted() {
        ...
        rightBorderView.setOnDragListener(new CloseableOnDragListener(new CloseableOnDragListener.OnDropListener() {
            @Override
            void onDragStarted() {
                imageView.setVisibility(View.INVISIBLE);
            }
        ...
        topBorderView.setOnDragListener(new CloseableOnDragListener(new CloseableOnDragListener.OnDropListener() {
            @Override
            void onDragStarted() {
                imageView.setVisibility(View.INVISIBLE);
            }
        ...
        bottomBorderView.setOnDragListener(new CloseableOnDragListener(new CloseableOnDragListener.OnDropListener() {
            @Override
            void onDragStarted() {
                imageView.setVisibility(View.INVISIBLE);
            }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        final View.DragShadowBuilder shadowBuilder = new CloseableDragShadowBuilder(imageView, offset);
